...
public class Numbers
{
	...
	{
		/*
		 * Write a Java program that will read and store a series of integers input by the user
		 * ending with zero in an array nums (Number of integers must not exceed 100).
		 */
		Scanner input = new Scanner(System.in);
		
		int nums[] = new int[100];
		int i = 0; //number of numbers entered
		...
		{
			if (j >= k)
				System.out.println("ERROR: k must be greater than j");
		...
		int l = 0; //index of nums2 and number of numbers entered in nums2
